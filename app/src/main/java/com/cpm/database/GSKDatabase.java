...
public class GSKDatabase extends SQLiteOpenHelper {
	...
	public static final String DATABASE_NAME = "Meccans_DATABASEss";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(CommonString.CREATE_TABLE_Visited_Store_INSERT_DATA);
	...
	/*	db.delete("OPENING_STOCK_DATA", null, null);
		...
		db.delete( "visited_store_data", null, null);
...
//get DeepFreezerType Data from Master
	...
	public void insertFscingCompetitorData(ArrayList<FacingCompetitorGetterSetter> data,String store_cd) {
		...
		try {
			...
			for (int i = 0; i < data.size(); i++) {
				...
				values.put("CATEGORY_CD", Integer.parseInt(data.get(i).getCategory_cd()));
				values.put("CATEGORY", data.get(i).getCategory());
				values.put("MCCAIN_DF", data.get(i).getMccaindf());
...
//get Facing Competitor Data
	...
	public ArrayList<OpeningStockInsertDataGetterSetter> getStockAvailabilityData(String store_cd) {
		Log.d("FetchingStoredata--------------->Start<------------",
				"------------------");
		ArrayList<OpeningStockInsertDataGetterSetter> list = new ArrayList<OpeningStockInsertDataGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT DISTINCT SD.BRAND_CD, SD.BRAND FROM MAPPING_AVAILABILITY CD INNER JOIN SKU_MASTER SD ON CD.SKU_CD = SD.SKU_CD WHERE CD.STORE_CD ='"+store_cd+"' ORDER BY CD.BRAND_SEQUENCE"
							, null);
			...
			if (dbcursor != null) {
				dbcursor.moveToFirst();
				while (!dbcursor.isAfterLast()) {
					OpeningStockInsertDataGetterSetter sb = new OpeningStockInsertDataGetterSetter();
	...
	public ArrayList<OpeningStockInsertDataGetterSetter> getFoodStoreAvailabilityData(String store_cd) {
		Log.d("FetchingStoredata--------------->Start<------------",
				"------------------");
		ArrayList<OpeningStockInsertDataGetterSetter> list = new ArrayList<OpeningStockInsertDataGetterSetter>();
		Cursor dbcursor = null;
	...
	public ArrayList<StockGetterSetter> getStockSkuData(String brand_cd,String store_cd) {
		Log.d("FetchingStoredata--------------->Start<------------",
				"------------------");
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT DISTINCT SD.SKU_CD, SD.SKU,SD.CATEGORY_TYPE FROM MAPPING_AVAILABILITY CD INNER JOIN SKU_MASTER SD ON CD.SKU_CD = SD.SKU_CD WHERE CD.STORE_CD = '" + store_cd +"' AND  SD.BRAND_CD ='"+brand_cd+"' ORDER BY CD.SKU_SEQUENCE"
							, null);
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					sb.setOpen_stock_cold_room("");
					sb.setOpen_stock_mccaindf("");
					sb.setOpen_stock_store_df("");
					sb.setTotal_facing_storedf("");
					sb.setTotalfacing_mccaindf("");
					sb.setMaterial_wellness("");
...
//Stock Sku Closing data
	...
	public ArrayList<StockGetterSetter> getStockSkuClosingData(String brand_cd, String store_cd) {
		Log.d("FetchingStoredata--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			dbcursor = db
					.rawQuery(
							"SELECT DISTINCT SD.SKU_CD, SD.SKU FROM MAPPING_AVAILABILITY CD INNER JOIN SKU_MASTER SD ON CD.SKU_CD = SD.SKU_CD WHERE CD.STORE_CD = '" + store_cd +"' AND SD.BRAND_CD ='"+brand_cd+"' ORDER BY CD.SKU_SEQUENCE"
							, null);
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					sb.setClos_stock_cold_room("");
					sb.setClos_stock_meccaindf("");
					sb.setClos_stock_storedf("");
...
//Stock Midday Sku data
	...
	public ArrayList<StockGetterSetter> getStockSkuMiddayData(String brand_cd, String store_cd) {
		Log.d("FetchingStoredata--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
...
//Promotion brand data
	...
	public ArrayList<OpeningStockInsertDataGetterSetter> getPromotionBrandData(String store_cd) {
		Log.d("FetchingStoredata--------------->Start<------------",
				"------------------");
		ArrayList<OpeningStockInsertDataGetterSetter> list = new ArrayList<OpeningStockInsertDataGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT DISTINCT SD.BRAND_CD, SD.BRAND FROM MAPPING_PROMOTION CD INNER JOIN SKU_MASTER SD ON CD.SKU_CD = SD.SKU_CD WHERE CD.STORE_CD ='"+store_cd+"' ORDER BY CD.BRAND_SEQUENCE"
							, null);
...
//Promotion brand data
	...
	public ArrayList<AssetInsertdataGetterSetter> getAssetBrandData(String store_cd) {
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT DISTINCT BRAND_ID, BRAND FROM MAPPING_ASSET WHERE STORE_CD ='"+store_cd+"'"
							, null);
	...
	public ArrayList<PromotionInsertDataGetterSetter> getPromotionSkuData(String brand_cd,String store_cd) {
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT DISTINCT SD.SKU_CD, SD.SKU, CD.PROMOTION,CD.CATEGORY_TYPE FROM MAPPING_PROMOTION CD INNER JOIN SKU_MASTER SD ON CD.SKU_CD = SD.SKU_CD WHERE SD.BRAND_CD ='"+brand_cd+"' AND CD.STORE_CD ='"+store_cd+"' ORDER BY CD.SKU_SEQUENCE"
							, null);
...
*/
	...
	public void insertOpeningStockData(OpeningStockInsertDataGetterSetter data,String sku_cd) {
...
//Insert Opening Data with Brand
	...
	public void InsertOpeningStocklistData( String storeid,
											HashMap<OpeningStockInsertDataGetterSetter, List<StockGetterSetter>> data,List<OpeningStockInsertDataGetterSetter> save_listDataHeader) {
		...
		try {
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
					...
					values1.put("OPENING_STOCK_COLD_ROOM", data.get(save_listDataHeader.get(i)).get(j).getOpen_stock_cold_room());
					values1.put("OPENING_STOCK_MCCAIN_DF", data.get(save_listDataHeader.get(i)).get(j).getOpen_stock_mccaindf());
					values1.put("TOTAL_FACING_MCCAIN_DF", data.get(save_listDataHeader.get(i)).get(j).getTotalfacing_mccaindf());
					values1.put("OPENING_STOCK_STORE_DF", data.get(save_listDataHeader.get(i)).get(j).getOpen_stock_store_df());
					values1.put("TOTAL_FACING_STORE_DF", data.get(save_listDataHeader.get(i)).get(j).getTotal_facing_storedf());
					values1.put("MATERIAL_WELLNESS", data.get(save_listDataHeader.get(i)).get(j).getMaterial_wellness());
		...
		try {
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
					...
					values1.put("SKU", data.get(save_listDataHeader.get(i)).get(j).getSku());
					values1.put("SKU_CD", Integer.parseInt(data.get(save_listDataHeader.get(i)).get(j).getSku_cd()));
					values1.put("COLD_ROOM", data.get(save_listDataHeader.get(i)).get(j).getClos_stock_cold_room());
					values1.put("MCCAIN_DF", data.get(save_listDataHeader.get(i)).get(j).getClos_stock_meccaindf());
					values1.put("STORE_DF", data.get(save_listDataHeader.get(i)).get(j).getClos_stock_storedf());
					db.insert(CommonString.TABLE_STOCK_DATA, null, values1);
				}
			}
			db.setTransactionSuccessful();
...
//Insert Food Store List data
	...
	public void InsertFoodStorelistData( String storeid,
										 HashMap<OpeningStockInsertDataGetterSetter, List<FoodStoreInsertDataGetterSetter>> data,List<OpeningStockInsertDataGetterSetter> save_listDataHeader) {
...
//Insert Promotion Data with Brand
	...
	public void InsertPromotionData( String storeid,
									 HashMap<OpeningStockInsertDataGetterSetter, List<PromotionInsertDataGetterSetter>> data,List<OpeningStockInsertDataGetterSetter> save_listDataHeader) {
...
//Insert Asset Data with Brand
	...
	public ArrayList<AssetInsertdataGetterSetter> getAssetDataFromdatabase(String storeId, String brand_cd ) {
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.ASSET_CD,SD.ASSET,SD.PRESENT,SD.REMARK,CD.BRAND_CD,CD.BRAND " +
...
//Get Asset Upload Data 
	...
	public ArrayList<PromotionInsertDataGetterSetter> getPromotionUpload(String storeId) {
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.SKU_CD,SD.PROMOTION,SD.CATEGORY_TYPE,SD.PRESENT,SD.REMARK, CD.BRAND_CD,CD.BRAND " +
	...
	public ArrayList<PromotionInsertDataGetterSetter> getPromotionDataFromDatabase(String storeId, String brand_cd) {
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.SKU_CD, SD.SKU, SD.PROMOTION,SD.CATEGORY_TYPE,SD.PRESENT,SD.REMARK, CD.BRAND_CD,CD.BRAND " +
									"FROM openingHeader_Promotion_data CD INNER JOIN PROMOTION_DATA SD ON CD.KEY_ID=SD.Common_Id WHERE CD.STORE_CD= '"
									+ storeId + "' AND CD.BRAND_CD = '"+ brand_cd +"'", null);
...
//Get Stock Upload Data 
	...
	public ArrayList<StockGetterSetter> getStockUpload(String storeId) {
		Log.d("FetchingPromotionuploaddata--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SKU_CD, AS_PER_MCCAIN, ACTUAL_LISTED,CATEGORY_TYPE, OPENING_STOCK_COLD_ROOM, OPENING_STOCK_MCCAIN_DF, TOTAL_FACING_MCCAIN_DF, OPENING_STOCK_STORE_DF, TOTAL_FACING_STORE_DF, MATERIAL_WELLNESS, BRAND_CD, BRAND, COLD_ROOM, MCCAIN_DF, STORE_DF, MIDDAY_STOCK " +
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("OPENING_STOCK_MCCAIN_DF"))==null|| dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("OPENING_STOCK_MCCAIN_DF")).equals("")){

						sb.setOpen_stock_mccaindf("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("TOTAL_FACING_MCCAIN_DF"))==null|| dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("TOTAL_FACING_MCCAIN_DF")).equals("")){

						sb.setTotalfacing_mccaindf("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("TOTAL_FACING_STORE_DF"))==null|| dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("TOTAL_FACING_STORE_DF")).equals("")){

						sb.setTotal_facing_storedf("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("OPENING_STOCK_STORE_DF"))==null|| dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("OPENING_STOCK_STORE_DF")).equals("")){

						sb.setOpen_stock_store_df("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("COLD_ROOM"))==null || dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("COLD_ROOM")).equals("")){
						sb.setClos_stock_cold_room("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("MCCAIN_DF"))==null|| dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("MCCAIN_DF")).equals("")){

						sb.setClos_stock_meccaindf("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("STORE_DF"))==null || dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("STORE_DF")).equals("")){

						sb.setClos_stock_storedf("0");
					...
					if(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("MIDDAY_STOCK"))==null || dbcursor.getString(dbcursor
							.getColumnIndexOrThrow("MIDDAY_STOCK")).equals("")){
...
//get opening stock data from database
	...
	public ArrayList<StockGetterSetter> getOpeningStockDataFromDatabase(String storeId, String brand_cd) {
		Log.d("FetchingOpening Stock data--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.SKU_CD, SD.SKU, SD.CATEGORY_TYPE, SD.AS_PER_MCCAIN, SD.ACTUAL_LISTED, SD.OPENING_STOCK_COLD_ROOM, SD.OPENING_STOCK_MCCAIN_DF ,SD.TOTAL_FACING_MCCAIN_DF ,SD.OPENING_STOCK_STORE_DF ,SD.TOTAL_FACING_STORE_DF ,SD.MATERIAL_WELLNESS FROM openingHeader_data CD INNER JOIN STOCK_DATA SD ON CD.KEY_ID=SD.Common_Id WHERE CD.STORE_CD= '"
									+ storeId + "' AND CD.BRAND_CD = '"+ brand_cd +"'", null);
	...
	public boolean isOpeningDataFilled(String storeId){
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT OPENING_STOCK_COLD_ROOM, MATERIAL_WELLNESS FROM STOCK_DATA WHERE STORE_CD= '" + storeId + "'", null);

			if (dbcursor != null) {
				dbcursor.moveToFirst();
				while (!dbcursor.isAfterLast()) {

					if(dbcursor.getString(dbcursor.getColumnIndexOrThrow("OPENING_STOCK_COLD_ROOM")).equals("") || dbcursor.getString(dbcursor.getColumnIndexOrThrow("MATERIAL_WELLNESS")).equals("")){
						filled=false;
						break;
					}
					else{
...
//get Opening and Midday stock data for comparison from database
	...
	public ArrayList<StockGetterSetter> getOpeningNMiddayStockDataFromDatabase(String storeId, String brand_cd) {
		Log.d("FetchingOpening Stock data--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.SKU_CD, SD.SKU, SD.OPENING_STOCK_COLD_ROOM, SD.OPENING_STOCK_MCCAIN_DF, SD.OPENING_STOCK_STORE_DF, SD.MIDDAY_STOCK FROM openingHeader_data CD INNER JOIN STOCK_DATA SD ON CD.KEY_ID=SD.Common_Id WHERE CD.STORE_CD= '"
									+ storeId + "' AND CD.BRAND_CD = '"+ brand_cd +"'", null);
...
//get Closing stock data from database
	...
	public ArrayList<StockGetterSetter> getClosingStockDataFromDatabase(String storeId, String brand_cd) {
		Log.d("FetchingOpening Stock data--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.SKU_CD, SD.SKU, SD.COLD_ROOM, SD.MCCAIN_DF, SD.CATEGORY_TYPE, SD.STORE_DF FROM openingHeader_data CD INNER JOIN STOCK_DATA SD ON CD.KEY_ID=SD.Common_Id WHERE CD.STORE_CD= '"
									+ storeId + "' AND CD.BRAND_CD = '"+ brand_cd +"'", null);
...
//get Closing stock data from database
	...
	public boolean isClosingDataFilled(String storeId){
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT COLD_ROOM FROM STOCK_DATA WHERE STORE_CD= '" + storeId + "'", null);

			if (dbcursor != null) {
				dbcursor.moveToFirst();
				while (!dbcursor.isAfterLast()) {

					if(dbcursor.getString(dbcursor.getColumnIndexOrThrow("COLD_ROOM")).equals("") ){
						filled=false;
						break;
					}
					else{
...
//get Midday stock data from database
	...
	public ArrayList<StockGetterSetter> getMiddayStockDataFromDatabase(String storeId, String brand_cd) {
		Log.d("FetchingOpening Stock data--------------->Start<------------",
				"------------------");
		ArrayList<StockGetterSetter> list = new ArrayList<StockGetterSetter>();
		Cursor dbcursor = null;
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.SKU_CD, SD.SKU, SD.MIDDAY_STOCK, SD.CATEGORY_TYPE FROM openingHeader_data CD INNER JOIN STOCK_DATA SD ON CD.KEY_ID=SD.Common_Id WHERE CD.STORE_CD= '"
									+ storeId + "' AND CD.BRAND_CD = '"+ brand_cd +"'", null);
	...
	public boolean isMiddayDataFilled(String storeId){
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT MIDDAY_STOCK FROM STOCK_DATA WHERE STORE_CD= '" + storeId + "'", null);
...
//Delete Stock Data Midday
	...
	public void updateMiddayStockData( String storeid,
									   HashMap<OpeningStockInsertDataGetterSetter, List<MiddayStockInsertData>> data,List<OpeningStockInsertDataGetterSetter> save_listDataHeader) {
...
//get DeepFreezerType Data
	...
	public String getVisiteDateFromCoverage(String storeid) {
		...
		String visite_date= "";
		try {
			dbcursor = db.rawQuery("SELECT  * from " + CommonString.TABLE_COVERAGE_DATA + "  WHERE " + CommonString.KEY_STORE_ID + " ='" + storeid + "'", null);

			if (dbcursor != null) {
				dbcursor.moveToFirst();
				visite_date = dbcursor.getString(dbcursor.getColumnIndexOrThrow(CommonString.KEY_VISIT_DATE));
				dbcursor.close();
	...
	public void updateStoreStatusOnCheckout(String storeid, String visitdate,
		...
		try {
			...
			db.update("JOURNEY_PLAN", values, CommonString.KEY_STORE_CD + "='" + storeid + "' AND " + CommonString.KEY_VISIT_DATE + "='" + visitdate
					+ "'", null);
		} catch (Exception e) {
...
//get Calls Data
	...
	public void insertvisitedData(String store_cd, String visit_date,String _pathforcheck) {

		db.delete(CommonString.TABLE_Visited_Store_INSERT_DATA, "STORE_ID" + "='" + store_cd + "'", null);
		ContentValues values = new ContentValues();

		try {
			values.put("IMAGE_PATH", _pathforcheck);

			values.put("VISITED_DATE", visit_date);

			values.put("STORE_ID", store_cd);

			db.insert(CommonString.TABLE_Visited_Store_INSERT_DATA, null, values);

		} catch (Exception ex) {
			Log.d("Database Exception while Insert Visited Store Data ",
					ex.toString());
		}
	...
	public ArrayList<CallsGetterSetter> getImageData(String store_cd) {
		...
		try {
			dbcursor = db.rawQuery("SELECT * from visited_store_data where STORE_ID = '" + store_cd + "'"
					, null);
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					fc.setPath(dbcursor.getString(dbcursor
