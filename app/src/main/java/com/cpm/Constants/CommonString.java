...
public class CommonString {
	...
	public static final String TABLE_Visited_Store_INSERT_DATA = "visited_store_data";
	
	/*public static final String CREATE_TABLE_Visited_Store_INSERT_DATA = "CREATE TABLE IF NOT EXISTS "
			+ TABLE_Visited_Store_INSERT_DATA
			+ "("
			+ "KEY_ID"
			+ " INTEGER PRIMARY KEY AUTOINCREMENT ,"
	...
	public static final String CREATE_TABLE_Visited_Store_INSERT_DATA =
			"CREATE TABLE IF NOT EXISTS visited_store_data(KEY_ID INTEGER PRIMARY KEY AUTOINCREMENT," +
					" STORE_ID VARCHAR, IMAGE_PATH VARCHAR, VISITED_DATE VARCHAR)";
	...
	public static final String CREATE_TABLE_FACING_COMPETITOR_DATA = "CREATE TABLE IF NOT EXISTS FACING_COMPETITOR_DATA(KEY_ID INTEGER PRIMARY KEY AUTOINCREMENT, STORE_CD INTEGER, CATEGORY_CD INTEGER, CATEGORY VARCHAR, MCCAIN_DF VARCHAR, STORE_DF VARCHAR)";

	public static final String TABLE_STOCK_DATA="STOCK_DATA";
	public static final String CREATE_TABLE_STOCK_DATA = "CREATE TABLE IF NOT EXISTS STOCK_DATA(Common_Id INTEGER, SKU_CD INTEGER,SKU VARCHAR, BRAND_CD VARCHAR, BRAND VARCHAR,STORE_CD VARCHAR, CATEGORY_TYPE VARCHAR, AS_PER_MCCAIN VARCHAR, ACTUAL_LISTED VARCHAR, OPENING_STOCK_COLD_ROOM VARCHAR, OPENING_STOCK_MCCAIN_DF VARCHAR, TOTAL_FACING_MCCAIN_DF VARCHAR, OPENING_STOCK_STORE_DF VARCHAR, TOTAL_FACING_STORE_DF VARCHAR, MATERIAL_WELLNESS VARCHAR, MIDDAY_STOCK VARCHAR, COLD_ROOM VARCHAR, MCCAIN_DF VARCHAR, STORE_DF VARCHAR)";
	...
	public static final String CREATE_TABLE_PROMOTION_DATA = "CREATE TABLE IF NOT EXISTS PROMOTION_DATA(Common_Id INTEGER,SKU_CD INTEGER,SKU VARCHAR,STORE_CD VARCHAR, PROMOTION VARCHAR, CATEGORY_TYPE VARCHAR, PRESENT VARCHAR, REMARK VARCHAR)";

	public static final String TABLE_ASSET_DATA="ASSET_DATA";
	public static final String CREATE_TABLE_ASSET_DATA = "CREATE TABLE IF NOT EXISTS ASSET_DATA(Common_Id INTEGER,ASSET_CD INTEGER,STORE_CD VARCHAR, ASSET VARCHAR, PRESENT VARCHAR, REMARK VARCHAR)";
	...
	public static final String METHOD_UPLOAD_LATTITUTE_LONGITUDE = "UploadUserLocation";
	public static final String SOAP_UPLOAD_LATTITUTE_LONGITUDE = "http://tempuri.org/"+ METHOD_UPLOAD_LATTITUTE_LONGITUDE;
