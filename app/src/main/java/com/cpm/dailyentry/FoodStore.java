...
public class FoodStore extends Activity implements OnClickListener{
	...
	HashMap<OpeningStockInsertDataGetterSetter, List<FoodStoreInsertDataGetterSetter>> listDataChild;
	...
	private void prepareListData() {
		...
		listDataChild = new HashMap<OpeningStockInsertDataGetterSetter, List<FoodStoreInsertDataGetterSetter>>();
	...
	public class ExpandableListAdapter extends BaseExpandableListAdapter {
		...
		private HashMap<OpeningStockInsertDataGetterSetter, List<FoodStoreInsertDataGetterSetter>> _listDataChild;

		public ExpandableListAdapter(Context context, List<OpeningStockInsertDataGetterSetter> listDataHeader,
									 HashMap<OpeningStockInsertDataGetterSetter, List<FoodStoreInsertDataGetterSetter>> listChildData) {
		...
		public View getChildView(final int groupPosition, final int childPosition,
				...
				public void onFocusChange(View v, boolean hasFocus) {
					...
					if (!hasFocus) {
						...
						if (value1.equals("")) {
							...
							_listDataChild.get(listDataHeader.get(groupPosition)).get(childPosition).setMccain_df("");

						} else {

							ischangedflag=true;
							_listDataChild.get(listDataHeader.get(groupPosition)).get(childPosition).setMccain_df(value1);
				...
				public void onFocusChange(View v, boolean hasFocus) {
					...
					if (!hasFocus) {
						...
						if (value1.equals("")) {
							...
							_listDataChild.get(listDataHeader.get(groupPosition)).get(childPosition).setStore_df("");

						} else {

							ischangedflag=true;

							_listDataChild.get(listDataHeader.get(groupPosition)).get(childPosition).setStore_df(value1);
				...
				public void onFocusChange(View v, boolean hasFocus) {
					...
					if (!hasFocus) {
						...
						if (value1.equals("")) {
							...
							_listDataChild.get(listDataHeader.get(groupPosition)).get(childPosition).setMtd_sales("");

						} else {

							ischangedflag=true;

							_listDataChild.get(listDataHeader.get(groupPosition)).get(childPosition).setMtd_sales(value1);
			...
			holder.etpackingsize.setId(childPosition);
			holder.etmccaindf.setId(childPosition);
			holder.etstoredf.setId(childPosition);
			holder.etmtdsales.setId(childPosition);
	...
	private void showKeyboardWithAnimation() {
		if (mKeyboardView.getVisibility() == View.GONE) {
			Animation animation = AnimationUtils.loadAnimation(FoodStore.this, R.anim.slide_in_bottom);
	...
	public void onBackPressed() {
		...
		if (mKeyboardView.getVisibility() == View.VISIBLE) {
			...
			if(ischangedflag){
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(FoodStore.this);
	...
	boolean validateData(
			HashMap<OpeningStockInsertDataGetterSetter, List<FoodStoreInsertDataGetterSetter>> listDataChild2,
